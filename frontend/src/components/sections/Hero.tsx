...
const Hero: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center bg-dark-300 overflow-hidden">
      <canvas
        ref={canvasRef}
      ...
      <div className="container mx-auto px-4 z-10 pt-20">
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="w-full md:w-1/2 mb-12 md:mb-0">
            ...
            >
              AI-powered real interview simulator to practice, analyze, and ace your dream job.
            </motion.p>
            <motion.div 
            ...
            >
              <Button primary onClick={handleStartPractice}>Start Practice</Button>
          ...
          <div className="w-full md:w-1/2">
            ...
            >
              <div className="relative bg-dark-200 p-6 rounded-xl border border-gray-800 shadow-xl animate-float">
                <div className="absolute -top-10 -left-10 w-20 h-20 bg-gradient-to-br from-primary-500 to-secondary-600 rounded-full flex items-center justify-center">
                  <svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M3 12H8" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
